 ...
 *
 * \file      OranrrhHandlerORanOperations.cpp
 ...
 */
static std::string MakeUniqueInstanceId()
{
    const std::string productCode{"MY_PRODUCT"};
    ...
    return productCode + "-" + std::string(hostname) + "-" + std::to_string(millis);
}
...
//-------------------------------------------------------------------------------------------------------------
OranrrhHandlerORanOperations::OranrrhHandlerORanOperations(std::shared_ptr<IYangModuleMgr> moduleMgr)
	: YangHandlerSysrepo("o-ran-operations", moduleMgr, "OranrrhHandlerORanOperations")
	, mCallback(std::make_shared<SysrepoGetitemsCallback>(path("operational-info")))
{}


//-------------------------------------------------------------------------------------------------------------
bool OranrrhHandlerORanOperations::initialise()
{
	...
	REGISTER_RPC("reset", OranrrhHandlerORanOperations::rpcReset) ;
 ...
 */
bool OranrrhHandlerORanOperations::rpcReset(
...
//-------------------------------------------------------------------------------------------------------------
void OranrrhHandlerORanOperations::valueChange(const string &xpath,
		shared_ptr<YangParam> oldValue,
		shared_ptr<YangParam> newValue)
{

	logDebugVerbose("OranrrhHandlerORanOperations::valueChange() - %s", xpath.c_str());
...
void OranrrhHandlerORanOperations::callTzSet()
{
	// string tz = getenv("TZ");
